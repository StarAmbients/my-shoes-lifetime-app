...
Neste projeto você deverá implementar um programa que simule um xxxx. Este programa deverá ser capaz de identificar ocorrências de xxxxx.
...
<details>
  <summary><strong>🗓 Fecha de Entrega</strong></summary><br />

  - Este proyecto es `individual`;
  - Previstos `3` dias de proyecto;
  - Fecha de entrega: `12/12/2022 16:00`.
...
<details>
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-019-c-project-ting/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-019-c-project-ting/pulls) e confira que o seu _Pull Request_ está criado
